...
// biome-ignore lint/nursery/noSecrets: This is a constant for error handling.
export const AUTH_CLIENT_NOT_INITIALIZED = "AuthClient has not been initialized. Please call createAuthClient() first.";
